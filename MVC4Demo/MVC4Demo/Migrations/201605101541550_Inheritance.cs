namespace MVC4Demo.Migrations
{
    ...
    public partial class Inheritance : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("INSERT INTO dbo.Person (LastName, FirstMidName, HireDate, EnrollmentDate, Discriminator, OldId) SELECT LastName, FirstMidName, null AS HireDate, EnrollmentDate, 'Student' AS Discriminator, StudentId AS OldId FROM dbo.Student");
            Sql("INSERT INTO dbo.Person (LastName, FirstMidName, HireDate, EnrollmentDate, Discriminator, OldId) SELECT LastName, FirstMidName, HireDate, null AS EnrollmentDate, 'Instructor' AS Discriminator, InstructorId AS OldId FROM dbo.Instructor");
